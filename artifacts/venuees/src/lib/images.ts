...
export const venuePhotos: Record<string, VenuePhotos> = {
  "signature-resorts-nagpur": signatureResortsPhotos,
...
export const destinationPhotos: Record<string, string> = {
  udaipur:   U("1590080875515-8a3a8dc5735e"),
  goa:       U("1512343879784-a960bf40e7f2"),
  jaipur:    U("1599661046289-e31897846e41"),
  coorg:     U("1587502537745-84b86da1204f"),
  jaisalmer: U("1524492412937-b28074a5d7da"),
  rishikesh: U("1585155770447-2f66e2a397b5"),
};
