  ...
  return (
    <div>
      ...
      <section className="page-hero">
        ...
        <p>87 vetted wedding vendors across Nagpur. Every one has shot, styled, or served at least 10 weddings we&rsquo;ve managed. Transparent pricing, portfolio links, and verified reviews.</p>
      </section>
