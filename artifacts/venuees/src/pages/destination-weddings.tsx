    ...
    <div className="dh">
      ...
      <section className="dh-section" style={{ paddingTop: 20 }}>
        ...
        <div className="pkg-compare">
          ...
          <div className="head"><h3>Heritage</h3><div className="p">₹12,500<small>/head</small></div></div>
          <div className="head feat"><h3>Signature</h3><div className="p">₹18,500<small>/head</small></div></div>
          <div className="head"><h3>Royal</h3><div className="p">₹28,000<small>/head</small></div></div>
          {[
