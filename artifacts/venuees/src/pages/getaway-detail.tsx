...
import { getGetawayBySlug } from "../lib/data";
...
export default function GetawayDetailPage() {
  ...
  if (!g) return <Redirect to="/weekend-getaways" />;
        ...
        <div>
          ...
          <section style={{ marginTop: 30 }}>
            ...
            <p style={{ fontSize: 15, lineHeight: 1.7, color: "var(--ink-soft)", maxWidth: 680 }}>
              Four acres of fenced grounds, a pool that looks like it&rsquo;s been there forever, and a kitchen that smells of filter coffee at 6am. The property is yours end-to-end — no other bookings on your dates, no neighbors sharing the pool.
            </p>
          ...
          <section style={{ marginTop: 40 }}>
            ...
            <div className="gd-nearby">
              <div><div className="ph garden" /><div className="lbl"><h5>Core forest gate</h5><small>12 min drive</small></div></div>
              <div><div className="ph ocean" /><div className="lbl"><h5>Lake viewpoint</h5><small>8 min drive</small></div></div>
              <div><div className="ph v5" /><div className="lbl"><h5>Village market</h5><small>4 min drive</small></div></div>
              <div><div className="ph v3" /><div className="lbl"><h5>Heritage temple</h5><small>18 min drive</small></div></div>
            </div>
          </section>
